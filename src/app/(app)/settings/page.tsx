import { DemoSettingsPage } from "@/components/demo/demo-settings-page";
  ...
  return (
    <div className="space-y-6">
      <PageHeading
        ...
        description="Account identity, connection status, and the little style decisions that make the app feel like home."
      />
